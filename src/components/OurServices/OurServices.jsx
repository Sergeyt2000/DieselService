...
export default function OurServices() {
  const decsriptionTNVD =
    "Виконуємо професійну діагностику та ремонт ПНВТ (Common rail) з точним дотриманням технологічних стандартів. На сучасному спеціалізованому обладнанні дозволяють швидко та якісно виконувати роботи.";
